...
<body>
    <div class="EventBooking_details_box_all">
        <div class="animate__animated animate__fadeInUp">
            <a href="change_status_event.php"><button type="button" class="page_button">Change Payment
                    Status</button></a>
        </div>
        <div class="animate__animated animate__fadeInUp">
            <div>
        ...
        $select_query = "SELECT * FROM EventBooking_details";
