...
<html>
    ...
    <body>
        <div class="box animate__animated animate__fadeInUp">
            <form name="delete_complain" id="delete_complain" action="update_event_sql.php" method="post">
                <label class="head">Enter Event Number: </label>
                <input class="input_box" type="number" id="delete_event" name="delete_event" required>
        ...
        <div class="announcement_container animate__animated animate__fadeInUp" >
            ...
            <?php
                ...
                $select_query = 
                    "SELECT ID, Name_event, Type, event_space, Date_event, house_no 
                    FROM $table_name
                    WHERE status = 'F'";
                ...
                if (mysqli_num_rows($data) > 0) {
                    while ($row = mysqli_fetch_array($data)) {
                        ...
                        echo "<div>Date: &nbsp;&nbsp" . $row["Date_event"] . "</div>";
                        echo "<div>Event Name: &nbsp;&nbsp" . $row["Name_event"] . "</div>";
                        echo "<div>Event Type: &nbsp;&nbsp" . $row["Type"] . "</div>";
                        echo "<div>Event Space: &nbsp;&nbsp" . $row["event_space"] . "</div>";
                        echo "</div>";
                        echo "</p>";
                        echo "<hr/>";
                    }
