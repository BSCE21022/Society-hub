...
<body>
    <form class=" animate__animated animate__fadeInUp" name="edit_user_form" id="edit_user_form" action="edit_user_details_sql.php"
        method="post">
        <div> 
        ...
        <span style="vertical-align: middle; margin-right: 10px;">
            <input type="radio" name="gender" value="f"
                style="vertical-align: middle; margin-right: 5px; margin-top: -2px;">Female
        </span>
        <span style="vertical-align: middle;">
            <input type="radio" name="gender" value="m"
                style="vertical-align: middle; margin-right: 5px; margin-top: -2px;">Male
        </span><br />
        ...
        <div class="name">
            &nbsp;&nbsp;&nbsp;
            Date of Birth:
            <input type="date" id="dob" name="dob" required class="wide-input"
                style="display: inline-block; margin-top: 10px; margin-bottom:15px;margin-left: 10px; width: 605px">
        </div>
        <div class="name">
            &nbsp;&nbsp;&nbsp;
            Number of Family Members:
            <input type="number" name="family_mem" id="family_mem" class="wide-input"
                style="margin-left: 10px; width:603px; margin-bottom: 10px; ">
        </div>
        <div class="name">
