...
<body>
    <form class=" animate__animated animate__fadeInUp" name="add_user_form" id="add_user_form" action="add_user.php" method="post">
    ...
    <span style="vertical-align: middle;">
        ...
        <div class="name">
            ...
            <input type="number" name="family_mem" id="family_mem" class="wide-input" style="margin-left: 10px; width:603px; margin-bottom: 10px; ">
        </div>
        <div class="name">
