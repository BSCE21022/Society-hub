...
<html>
    ...
    <body>
        <div class="box animate__animated animate__fadeInUp">
            <form name="delete_announcements" id="delete_announcements" action="del_announce_sql.php" method="post">
                <label class="head">Enter Announcement Number: </label>
                <input class="input_box" type="number" id="delete_announcement" name="delete_announcement" required>
        ...
        <div class="announcement_container animate__animated animate__fadeInUp" >
            ...
            <?php
                ...
                $select_query = "SELECT ID, announce_text FROM $table_name";
