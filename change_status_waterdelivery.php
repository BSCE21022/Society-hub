...
<html>
    ...
    <body>
        <div class="box animate__animated animate__fadeInUp">
            <form name="delete_complain" id="delete_complain" action="update_water_sql.php" method="post">
                <label class="head">Enter Delivery Number: </label>
        ...
        <div class="announcement_container animate__animated animate__fadeInUp" >
            ...
            <?php
                ...
                $select_query = 
                    "SELECT ID, CD, BottlesNo, house_no 
                    FROM $table_name
                    WHERE status = 'F'";
                ...
                if (mysqli_num_rows($data) > 0) {
                    while ($row = mysqli_fetch_array($data)) {
                        ...
                        echo "<div>Number of Bottles: &nbsp;&nbsp" . $row["BottlesNo"] . "</div>";
                        echo "</div>";
                        echo "</p>";
                        echo "<hr/>";
                    }
